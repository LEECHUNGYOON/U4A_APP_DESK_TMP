let oAPP = (function () {
    ...
    return {
        ...
        _protcol: "http",
        _host: "dev-motorsport.hyundai.eucorp.local",
        _port: "8000",
        _path: "/zu4a/zhwmm11000",
        _params: "sap-client=120&sap-language=EN",
        _starturl: "",
        _Sessions: {
            "second": 0,
            "timeOUT": 5,
        ...
        onStart: function () {
            ...
            oAPP.oFrmWin = document.getElementById('u4aAppiFrame').contentWindow;
